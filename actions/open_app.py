...
def _launch_windows(app_name: str) -> bool:
    # Se resuelve la ruta real del ejecutable y se lanza SIN shell=True,
    # evitando que caracteres de shell (&, |, ;, etc.) en app_name puedan
    # inyectar comandos adicionales.
    ...
    if ":" in app_name:
        # Para URIs tipo "ms-settings:" — os.startfile usa ShellExecute
        # de forma segura, sin invocar una shell de comandos.
        try:
